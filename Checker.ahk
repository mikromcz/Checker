...
If (A_Language = "0405")        ; Czech
{
    ...
    Global textErrorFill        := "Chyba: Nelze vyplnit sou¯adnice!`n`nPravdÏpodobnÏ se naËetla öpatn· str·nka, nap¯Ìklad ozn·menÌ o p¯ekroËenÌ limitu.`nZkuste to jeötÏ jednou, a pokud se bude chyba opakovat, dejte mi vÏdÏt."
            ...
            If RegExMatch(wb.Document.body.innerHTML, correct)
            {
                ...
                If (copymsg = 1)
                {
                    ...
                    If (args[1] = "puzzlechecker")
                    {
                        ...
                        ;   GC kÛd: <a href="http://coord.info/GC80HFF" target="_blank">GC80HFF</a><BR>
                        ;   Sou¯adnice: N62&deg; 32.396 E17&deg; 27.523<BR>		Informace: Bonuskod: 4306</h3><BR>
                        ;   <input type="button" onClick="location.href='/?wp=GC80HFF'" value="ZpÏt">
                        ; </div>
...
Browser(ByRef wb)
{
    ...
    Else If (args[1] = "puzzlechecker") ; ============================================> PUZZLECHECKER (20)
    {
        ...
        ; Check result after page reload
        ; YES: <p align="center" class="greenb">Gratulujeme! Vaöe ¯eöenÌ je spr·vnÏ!</p> + <div class="tipblock" style="width:640px"><h3>Cache: TMK 1807 - Figures<BR>GC kÛd: <a href="http://coord.info/GC80HFF" target="_blank">GC80HFF</a><BR>Sou¯adnice: N62&deg; 32.396 E17&deg; 27.523<BR>		Informace: Bonuskod: 4306</h3><BR> ... </div>
        ; NO:  <p align="center" class="redb">Vaöe odpovÏÔ nenÌ spr·vnÏ!</p>
        If (answer = 1)
        {
    ...
    Else If (args[1] = "gocaching") ; ============================================> GOCACHING (21)
    {
        ...
        Try
        {
            ...
            ; Solving captcha
            ; <font size="-1" class="smallFont">Gibt bitte die Lˆsung zu folgenden Aufgabe ein:<br>2 + 7 = <input name="recaptcha_response_field" value="" size="2"><br></font>
